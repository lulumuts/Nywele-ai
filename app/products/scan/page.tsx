...
import { BottomNavHubShell, StyleCheckHubWhiteCard } from '@/app/components/BottomNavHubLayout';
  ...
  return (
    <BottomNavHubShell>
      ...
      <StyleCheckHubWhiteCard
        outerClassName="flex min-h-0 flex-1 flex-col justify-end pt-2 md:min-h-0 md:flex-1 md:justify-start md:pt-0"
